...
class Mark1TriggerBridge:
    ...
    def __init__(self, window, *, predictors=None, bundle_root=None):
        self.window = window
        self.bundle_root = Path(bundle_root or Path(__file__).resolve().parent.parent / self.bundle_directory)
