...
ZERO = Decimal("0")
HUNDRED = Decimal("100")
_EXECUTION_STATES = {"filled", "accepted", "cancelled"}
...
def realized_performance(records: Iterable[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    their execution price. Partial accepted/cancelled orders use confirmed
    filled_quantity. Other states are not execution evidence. Snapshot records
